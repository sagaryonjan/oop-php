<head>
    ...
    <!-- ace styles -->
    <link rel="stylesheet" href="<?php echo $path; ?>css/ace.min.css" class="ace-main-stylesheet" id="main-ace-style" />

    <!--[if lte IE 9]>
    <link rel="stylesheet" href="<?php echo $path; ?>css/ace-part2.min.css" class="ace-main-stylesheet" />
    <![endif]-->
    <link rel="stylesheet" href="<?php echo $path; ?>css/ace-skins.min.css" />
    ...
    <script src="<?php echo $path; ?>js/ace-extra.min.js"></script>
